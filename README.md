...
**Later analysis.** The history file records each paper's row index, title, downloaded filename, and timestamp, which you can join back to your original Scopus export for bibliometric work, coverage checks, or tracking what you actually retrieved vs. what was behind a paywall.
